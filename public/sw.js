/* Abdul Razak Catering — service worker.
 *
 * Deliberately conservative. This app handles quotations, payments and
 * per-user authenticated pages, so the rules are:
...
self.addEventListener('push', (event) => {
  let data = { title: 'Abdul Razak Catering', body: '', url: '/catering', tag: 'arc' };
  try {
