 ...
 *
 * Mirrors the printed slip's figures — items, grand total, received, balance —
 * so the message and the PDF cannot tell different stories. Plain text with no links: these get forwarded around families
