 ...
 */
const globalForDb = globalThis as unknown as { __arcPool?: Pool };
...
export function getConnectionConfig(): {
  ...
  return {
    ...
    database: process.env.DB_NAME ?? 'abdul_razak_catering',
  };
}

export function getPool(): Pool {
  if (!globalForDb.__arcPool) {
    globalForDb.__arcPool = mysql.createPool({
      ...getConnectionConfig(),
