...
export async function generateMetadata(): Promise<Metadata> {
  ...
  description: 'Wedding and event catering in Karachi: quotations, invoices and the books behind them.',
        ...
        */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('arc-theme')||'dark';var r=document.documentElement;r.classList.toggle('light',t==='light');r.classList.toggle('dark',t!=='light');}catch(e){}})();`,
          }}
        />
      </head>
